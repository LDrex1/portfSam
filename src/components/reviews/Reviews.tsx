...
function Reviews() {
  return (
    <div className="flex flex-col md:grid gap-x-3 md:gap-x-5 w-full sm:w-[60vw] sm:min-w-[450px] lg:min-w-[550px] lg:gap-x-8 gap-y-6 md:gap-y-5 lg:gap-y-8 sm:grid-cols-2 sm:auto-rows-min">
